...
?>
<div class="list_more"><a href="<?php echo Html::uriquery2('mod_static', 'view', array('sc_id'=>$curr_scontent->id)); ?>"><img src="<?php echo P_TPL_WEB; ?>/images/more_37.jpg" width="32" height="9" border="0" /></a></div>
