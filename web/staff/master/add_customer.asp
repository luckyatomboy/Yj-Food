...
sql="insert into Customer(CustomerName,Address,Tel,Fax,Email,Partner,Memo,CreateDate,Creator) values('"&nowusername&"','"&nowaddress&"','"&nowtel&"','"&nowfax&"','"&nowemail&"','"&nowpartner&"','"&nowbeizhu&"',#"&now()&"#,'"&session("redboy_username")&"')"
conn.execute(sql)
%>
<script language="javascript">
alert("客户添加成功！")
