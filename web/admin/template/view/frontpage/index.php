...
<span id="loginform_stat" style="text-align:center;margin-top:28px;	color:#999999;font-family:Arial,Helvetica,sans-serif;display:block;font-size:12px;">欢迎使用<?php if((!Toolkit::getAgent() && !IS_INSTALL) || (!ToolKit::getCorp() && IS_INSTALL)){ ?>企业网站<?php }else{ ?>模板林网站<?php }?>管理系统</span>
<div id="footer">
<?php if((!Toolkit::getAgent() && !IS_INSTALL) || (!ToolKit::getCorp() && IS_INSTALL)){ echo $footer; }else{ ?>Copyright © 2014 mobanlin.com All Rights Reserved.<?php }?>
</div>