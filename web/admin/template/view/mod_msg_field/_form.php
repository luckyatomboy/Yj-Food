...
//				 addLoadingDiv();
				 $.post(parseToAdminURL('mod_msg_field','admin_save'),param ,function(o_result) {
						 ...
						 if (o_result.result == "ERROR") {
							...
							location.href="<?php echo Html::uriquery('mod_msg_field', 'admin_list');?>";
...
function backPrv(){
	window.location.href="index.php?_m=mod_msg_field&_a=admin_list";	
}
//-->
</script>
...
<form id="fieldaform" action="<?php echo Html::xuriquery('mod_msg_field', $next_action)?>" >
