         ...
         <td class="label"><?php echo __('Swf file');?></td>
          ...
          <?php if(!$lhtype){$lhtype=4;}?>
			...
			?>
			  ...
			  </script> </div>  <div id="addclick" style="float:left;<?php if($geshi=='2') echo 'display:none'; ?>">   <a href="javascript:void(0);" onClick="additem();return false;"><font style=" margin-left:15px; font-size:14px; font-weight:bold;"><?php echo __('Add Slide items');?></font></a></div>
              </td></tr>
            <tr>
