...
<title><?php if((!Toolkit::getAgent() && !IS_INSTALL) || (!ToolKit::getCorp() && IS_INSTALL)){ echo '企业网站';}else{ echo '模板林';} ?>后台管理系统</title>
...
<div class="dashboard_footer2" id="bottom"><?php if((!Toolkit::getAgent() && !IS_INSTALL) || (!ToolKit::getCorp() && IS_INSTALL)){
	...
	echo '模板林网站建设系统 版本 V2.7 星辰科技<br />Copyrigt@2014 mobanlin.com All Right Reserved';
}	
