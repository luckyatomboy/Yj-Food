...
.pageinput {width:18px;_width:18px}
...
.page_square_bg{ width:15px;height:13px;_width:15px;_height:13px;background-color:#0468B4; border:1px #F6F4F2 solid;padding:0 3px;_padding:0 3px;}
