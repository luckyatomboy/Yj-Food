        ...
        try {
	    	...
	    	switch ($status) {
    			case 'bbs':
    				...
    				$xml->getElementsByTagName('bbs_url')->item(0)->nodeValue = htmlentities($url);
    			...
    			case 'host':
    				...
    				$xml->getElementsByTagName('host_url')->item(0)->nodeValue = htmlentities($url);
...
EOT;
	...
	public static function frontpagemapping(){
		...
		{
			$legal_key = array("19c8662171267e9c7fc3a60565f5f34e");
